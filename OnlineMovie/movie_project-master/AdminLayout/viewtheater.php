 ...
 <table class=" container table table-stripped table-bordered" style = "width:80%">
    ...
    <?php while ($data = mysqli_fetch_assoc($res)) {
        echo '<tr>'; ?>
                    ...
                    <td><a href="theaterEdit.php?id=<?= @$data[
                        'id'
                    ] ?>" class = "btn btn-primary">Edit</a>
                    <a href="viewtheater.php?Delid=<?= @$data[
                        'id'
                    ] ?>" class = "btn btn-danger" onclick = "return confirm('Are you sure you want to delete');return false;">Delete</a>
                    </td>
...
error_reporting(0);
$DelID = $_GET['Delid'];
$quer = "delete from theater where id = $DelID";
