                        ...
                        <div class="col-sm-12 col-lg-6" >
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="city" name = "Testing">
                                    ...
                                    <option value = "CRIP">Company Testing</option>
                                    <option value = "LRIP">Laboratory Testing</option>
...
<?php include 'CompanyEndHeader.php'; ?>
    ...
    if (mysqli_num_rows($res) > 0) {
        ...
        if (
            ...
            if ($FileSize <= 1000000) {
                ...
                $query = "insert into user (Name,Email,Password,Photo,Role) values ('$Name','$Email','$Password','$folder','$TesterRole')";
                echo $query;
